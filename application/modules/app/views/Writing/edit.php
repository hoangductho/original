					...
					<div class="panel-body">
						<div class="col-md-12 col-lg-12">
							<form id="article" role="form" class=" has-success">
								...
								<div class="form-group">
									<div class="col-lg-6 col-sm-12 non-padding-left" style="border-right: 1px solid #ddd; ">
										...
										<div class="form-group" >
											...
											<input id='avatar64' placeholder="Data Base64" type="text" name='image' hidden value="<?php echo $article['image'];?>">
											<br>
									...
									<div class="col-lg-6 col-sm-12 non-padding-right">
										...
										<div class="form-group">
											...
											<select name="privacy" class="form-control"  value="<?php echo $article['privacy'];?>">
						                        <option value="0" <?php echo $article['privacy'] == 0 ? 'selected' : null?>>Private</option>
						                        <option value="1" <?php echo $article['privacy'] == 1 ? 'selected' : null?>>Public</option>
						                        <option value="2" <?php echo $article['privacy'] == 2 ? 'selected' : null?>>Protected</option>
						                    </select>
										</div>
										<div class="form-group">
											<label>Trạng thái gửi </label>
											<select name="status" class="form-control"  value="<?php echo $article['status'];?>">
						                        <option value="0" <?php echo $article['status'] == 0 ? 'selected' : null?>>Draft</option>
						                        <option value="1" <?php echo $article['status'] == 1 ? 'selected' : null?>>Complete</option>
						                        <option value="2" <?php echo $article['status'] == 2 ? 'selected' : null?>>Editing</option>
						                        <option value="3" <?php echo $article['status'] == 3 ? 'selected' : null?>>Cancel</option>
						                    </select>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<input type="number" name="id" value="<?php echo $article['id']?>" hidden>
